    ...
    <section style={dynamicStyles}>
      <div className={styles.heroImageContainer}>
        ...
        <div className={styles.overlayItems} style={getOverlayPositionStyles()}>
         {heading?.value && (
  <h1
    className={`fx-title ${styles.header}`}
    style={{
      color: heading_color?.value || "inherit",
      fontSize: heading_font_size?.value
        ? `${heading_font_size.value}px`
        : "inherit",
    }}
  >
    {heading?.value}
         ...
         {description?.value && (
  <p
    className={`fx-description ${styles.description}`}
    style={{
      color: description_color?.value || "inherit",
      fontSize: description_font_size?.value
        ? `${description_font_size.value}px`
        : "inherit",
    }}
  >
    {description?.value}
...
<div className={styles.buttonContainer}>
  ...
  <FDKLink to={button_link?.value}>
    <button
      ...
      style={{
        color: button_text_color?.value || "#fff",
        backgroundColor: button_bg_color?.value || "#000",
      }}
...
{secondary_button_text?.value && (
  <FDKLink to={secondary_button_link?.value}>
    <button
      type="button"
      className={`fx-button ${styles.secondaryBtn} ${styles.cta_button}`}
      style={{
        color: secondary_button_text_color?.value || "#000",
        backgroundColor: secondary_button_bg_color?.value || "#eee",
      }}
      disabled={!(secondary_button_link?.value?.length > 0)}
    >
      {secondary_button_text?.value}
    </button>
  </FDKLink>
