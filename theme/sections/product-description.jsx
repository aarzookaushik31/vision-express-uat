...
import RecommendedProducts from "../page-layouts/pdp/components/simiar-products/similar-products";
...
import LocationIcon from "../assets/images/mage_location.png";
              ...
              {blocks &&
                blocks.map((block, index) => {
                  switch (block.type) {
                        ...
                        <div className={styles.titleBlock}>
                          {getBlockConfigValue(block, "show_brand") && (
                            <h3 className={`${styles.productBrand} fontHeader`}>
                              {brand?.name || ""} | {productDetails?.item_code}
                            </h3>
                          )}
                    ...
                    case "product_price":
                      return (
                          <div className={styles.priceShareContainer}>
                        <>
                          {show_price && (
