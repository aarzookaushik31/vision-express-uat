...
export function Component({ props = {}, blocks = [], globalConfig = {} }) {
  ...
  const {
    ...
    banner_between_products_mobile,
    banner_button_link,
    banner_title,
    banner_subtitle,
    banner_button_text,
  ...
  useEffect(() => {
      ...
      if (window.innerWidth <= 768) {
        setBgImage(banner_between_products_mobile?.value || banner_between_products?.value);
      } else {
        setBgImage(banner_between_products?.value);
      }
    };
  ...
  <img
        ...
        <img
          src={assets?.banners?.mobile || placeholderMobile}
          alt={listingProps.title || "Collection Banner Mobile"}
          className="collection-banner-img-mobile"
        />
  
  <div className="collection-banner-content">
    <h2>{listingProps.title}</h2>
    <p>{listingProps.description}</p>
  </div>
</div>
...
export const settings = {
  ...
  props: [
    ...
    },
    {
      ...
      options: [
        ...
        {
      type: "image_picker",
      id: "banner_between_products",
      label: "Product Banner",
      info: "This banner will be shown in Products",
      default: "",
    },
     {
      type: "image_picker",
      id: "banner_between_products_mobile",
      label: "Product Banner Mobile",
      info: "This banner will be shown in Products",
      default: "",
    },
    {
  ...
  id: "banner_title",
  label: "Banner Title",
  default: "Shop Vision Express Exclusive Collection Now"
},
{
  type: "textarea",
  id: "banner_subtitle",
