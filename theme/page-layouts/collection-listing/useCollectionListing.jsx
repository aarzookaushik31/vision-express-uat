...
const useCollectionListing = ({ fpi, slug, props }) => {
  ...
  banners: {
    desktop:
      customCollection?._custom_json?.["am-banner-image"]?.[0]?.url || null,
    mobile:
      customCollection?._custom_json?.["am-banner-image-mobile"]?.[0]?.url ||
      customCollection?._custom_json?.["am-banner-image"]?.[0]?.url ||
      null,
  },
};
